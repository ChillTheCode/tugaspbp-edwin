"""
Django settings for pbpedwin project.
...
WSGI_APPLICATION = 'pbpedwin.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://edwin-daniel-tugas.pbp.cs.ui.ac.id/']
